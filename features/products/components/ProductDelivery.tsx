...
export default function ProductDelivery() {
  ...
  return (
    <div className="border-4 border-black dark:border-brand-pink-light shadow-[6px_6px_0] shadow-brand-pink dark:shadow-brand-blue overflow-hidden mt-4">
      ...
      <div className="bg-white dark:bg-brand-pink-dark divide-y-2 divide-black dark:divide-brand-pink-light/30">
        <div className="flex items-start gap-4 px-5 py-4">
          <div className="mt-1 w-9 h-9 rounded-full bg-[#FFF0FA] dark:bg-brand-pink-bg-dark border-2 border-black dark:border-brand-blue flex items-center justify-center shrink-0">
