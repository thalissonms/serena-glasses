...
export const Nav = () => {
  ...
  return (
    <div className="bg-brand-pink dark:bg-brand-black-dark py-4 px-14 border-b-3 border-black dark:border-brand-pink-dark shadow-[6px_6px_0px_#000] dark:shadow-[6px_6px_0px_#FF00B6] sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              {/* Theme Toggle (substitui o User na v1 — sem login) */}
              <ThemeToggle />
            </div>
            ...
            >
              ...
              <div className="relative w-12 h-12 bg-brand-pink-light dark:bg-brand-pink-dark border-2 border-black dark:border-brand-pink-light flex items-center justify-center transform -rotate-2 group-hover:rotate-0 transition-transform duration-300">
                {isMenuOpen ? (
                  <X size={20} className="text-brand-black-dark dark:text-brand-pink-light" />
                ) : (
                  <Menu size={20} className="text-brand-black-dark dark:text-brand-pink-light" />
                )}
              </div>
            </button>
          </div>
