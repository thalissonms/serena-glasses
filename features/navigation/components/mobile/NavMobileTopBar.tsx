...
export const NavMobileTopBar = () => {
  return (
    <nav className="w-full text-black dark:text-white transition-colors transition-duration-300 md:hidden bg-brand-pink-light dark:bg-brand-pink-bg-dark z-50">
