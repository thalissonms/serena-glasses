 ...
 * Ações: editar (→ /admin-v2/banners/[id]), deletar (DELETE /api/admin/site-banners/[id]).
 *
 * Usado em: /admin-v2/banners.
 */
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => router.push("/admin-v2/banners/new")}
              ...
              >
                ...
                <div className="flex items-center justify-between px-4 py-2.5">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={() => router.push(`/admin-v2/banners/${b.id}`)}
