 ...
 *
 * Usado em: src/app/admin-v2/seo/page.tsx.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-3">
          <Search size={18} className="text-[#FF00B6]" />
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 font-mono text-[9px] uppercase tracking-widest border border-white/10 text-white/30 hover:border-white/20 hover:text-white/50 transition-colors"
              >
                ...
                {SITEMAP_SECTIONS.map((s, i) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <span className="px-2 py-0.5 font-mono text-[7px] uppercase tracking-widest border border-white/8 text-white/20">
                        {s.type}
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-3 font-mono text-[10px] text-white/20">
                      {s.changefreq}
                    </td>
      ...
      {tab === "robots" && (
        <div className="space-y-4">
          ...
          <div className="border border-white/8 bg-[#0a0a0a] p-5">
            <p className="font-mono text-[7px] uppercase tracking-[0.35em] text-white/15 mb-3">
              preview
            </p>
            <pre className="font-mono text-[10px] text-[#00F0FF]/50 leading-relaxed whitespace-pre">
              {ROBOTS_PREVIEW}
            </pre>
          </div>

          <div className="border border-[#FFD700]/20 bg-[#FFD700]/4 p-3 flex items-start gap-2">
            <Lock size={12} className="text-[#FFD700]/40 shrink-0 mt-0.5" />
            <p className="font-mono text-[9px] text-[#FFD700]/60 leading-relaxed">
              Para editar o robots.txt, modifique{" "}
              <span className="text-[#00F0FF]/50">src/app/robots.ts</span> e faça deploy.
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              disabled
              className="flex items-center gap-2 px-4 py-2 font-mono text-[10px] uppercase tracking-widest border border-white/8 text-white/15 cursor-not-allowed"
            >
              <Lock size={11} />
              + Nova Redirect
            </button>
          ...
          <div className="border border-[#00F0FF]/10 bg-[#00F0FF]/3 p-3">
            <p className="font-mono text-[9px] text-white/25 leading-relaxed">
              Redirects permanentes (301) podem ser adicionados em{" "}
              <span className="text-[#00F0FF]/50">next.config.ts</span> enquanto
