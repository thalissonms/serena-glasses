  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      >
        <div
          className={clsx(
            "w-10 h-10 relative isolate rounded-md transition-all duration-150",
            pressed
              ? [
                  "border-4 border-brand-black/80",
              ...
              : [
                  "border-4 border-brand-black/80 hover:border-brand-black",
                  "dark:border-brand-dark-surface-0",
                  isWishlisted
        ...
        >
          <div className="z-3 w-7 h-7 top-0.5 left-0.5 absolute flex justify-center items-center">
            ...
            >
              <Heart
                className={clsx(
                  "w-4.25 h-4.25 stroke-4 transition-all duration-300",
                  isWishlisted
          ...
          <div className="z-3 w-7 h-7 top-0.5 left-0.5 absolute flex justify-center items-center">
            <Heart
              className={clsx(
                "w-4.25 h-4.25 stroke-4 blur-lg transition-all duration-300",
                isWishlisted
          ...
          <div
            className={clsx(
              "z-2 absolute w-7 h-7 rounded-tl-[3px] rounded-bl-sx rounded-tr-xs rounded-br-sm",
          ...
          <div
            className={clsx(
              "z-1 w-full h-full absolute rounded-[3.25px] border-3 transition-all duration-150",
              pressed
