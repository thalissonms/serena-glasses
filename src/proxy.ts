...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    `connect-src 'self' https://api.mercadopago.com https://*.mercadopago.com https://http2.mlstatic.com https://*.mercadolibre.com https://api.mercadolibre.com ${supabaseUrl} https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net`,
    `media-src 'self' ${supabaseUrl}`,
    "frame-src 'self' https://*.mercadopago.com https://*.mercadolibre.com https://*.mercadolivre.com",
    "object-src 'none'",
    "base-uri 'self'",
