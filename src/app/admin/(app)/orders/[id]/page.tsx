/**
 * Page: /admin/orders/[id] — detalhe de pedido no painel admin v2.
 *
 ...
 *
 * Usado em: rota /admin/orders/[id].
 */
import { notFound } from "next/navigation";
import { requireAdmin } from "@shared/lib/auth/admin";
import { getSupabaseServer } from "@shared/lib/supabase/server";
import { OrderDetailClient } from "@features/admin/components/orders/OrderDetailClient";
