/**
 * Page: /admin-v2/orders — listagem de pedidos com filtros server-side Y2K Chrome.
 *
...
import { OrdersListClient } from "@features/admin-v2/components/orders/OrdersListClient";
