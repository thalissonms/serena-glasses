/**
 * Page: /admin-v2/logs — SCAFFOLD tabela de error_logs com filtros de tipo e data.
 *
...
import { LogsClient } from "@features/admin-v2/components/logs/LogsClient";
import type { ErrorLog } from "@features/admin-v2/components/logs/LogsClient";
