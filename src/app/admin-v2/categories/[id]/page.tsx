/**
 * Page: /admin-v2/categories/[id] — edição de categoria com subcategorias inline.
 *
...
import CategoryEditClient from "@features/admin-v2/components/categories/CategoryEditClient";
