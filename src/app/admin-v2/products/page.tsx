/**
 * Page: /admin-v2/products — listagem de produtos com filtros Y2K Chrome.
 *
...
import ProductsListClient from "@features/admin-v2/components/products/ProductsListClient";
